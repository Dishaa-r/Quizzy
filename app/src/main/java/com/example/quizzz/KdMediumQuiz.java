...
//
//public class KdMediumQuiz extends AppCompatActivity {
//
//    @Override
//    protected void onCreate(Bundle savedInstanceState) {
//        super.onCreate(savedInstanceState);
//        EdgeToEdge.enable(this);
//        setContentView(R.layout.activity_kd_medium_quiz);
...
public class KdMediumQuiz extends QuizActivity {

    @Override
    protected Map<String, String> getEmojiHints() {
        Map<String, String> hints = new HashMap<>();
        hints.put("⚡🐍", "ELECTRIC SNAKE");
        hints.put("🏞️🎒", "BACKPACKING");
